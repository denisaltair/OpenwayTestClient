...
public class ISOClientBuilder {
    ...
    public static class ClientBuilder {
        ...
        public ClientBuilder setSocketSoTimeout(int millisecond) {
            client.setSocketSoTimeout(millisecond);
            return this;
        }
    ...
    private static class DefaultISOClient implements ISOClient {
        ...
        private int socketSoTimeout=50000;
        ...
        public void connect() throws ISOClientException, IOException {
            ...
            else socketHandler.init(host,port, socketSoTimeout, isoClientEventListener);
        ...
        public byte[] sendMessageSync(byte[] value) throws ISOClientException, IOException {
        ...
        private void setSocketSoTimeout(int timeout) {
