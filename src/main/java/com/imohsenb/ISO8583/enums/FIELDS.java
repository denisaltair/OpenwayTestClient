...
// |Field title                        |no  |type  |len  |fixed |format|
    ...
    F22_EntryMode                       (22, "n",   4,    true,  null),
    F23_PANSequence                     (23, "n",   4,    true,  null),
    F24_NII_FunctionCode                (24, "n",   4,    true,  null),
    ...
    F49_CurrencyCode_Transactoion       (49, "n", 4,    true,  null),
    ...
    F64_MAC                             (64, "b",   4,   true,  null);
    //F64_MAC                             (64, "n",   4,   true,  null);
