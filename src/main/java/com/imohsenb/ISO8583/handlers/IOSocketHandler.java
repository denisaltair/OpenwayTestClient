...
public class IOSocketHandler implements SocketHandler {
    ...
    public void init(String host, int port,  int socketSoTimeout, ISOClientEventListener isoClientEventListener) throws IOException {

        this.isoClientEventListener = isoClientEventListener;
        this.socket=new Socket();
        this.socket.setSoTimeout(socketSoTimeout);
        this.socket.connect(new InetSocketAddress(host,port),socketSoTimeout);
